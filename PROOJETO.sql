...
-- CONSULTAS PARA MANIPULAÇÃO DOS DADOS

-- 1Listar todos os alunos
SELECT * FROM Aluno;

-- Listar alunos com seus respectivos cursos
SELECT 
    A.Nome_Aluno,
    A.Sobrenome_Aluno,
    C.Nome_Curso
...
-- Listar professores e seus departamentos
SELECT 
    P.Nome_Professor,
...
-- Listar disciplinas com seus departamentos
SELECT 
    Di.Nome_Disciplina,
    D.Nome_Departamento
FROM Disciplina Di
JOIN Departamento D ON Di.Cod_Departamento = D.Cod_Departamento;

-- Mostrar quais alunos fazem quais disciplinas
SELECT 
    A.Nome_Aluno,
    Di.Nome_Disciplina
FROM Aluno A
JOIN Aluno_Disc AD ON A.RA = AD.RA
JOIN Disciplina Di ON AD.Cod_Disciplina = Di.Cod_Disciplina;

-- Mostrar professores e as disciplinas que lecionam
SELECT 
    P.Nome_Professor,
    Di.Nome_Disciplina
FROM Professor P
...
-- Mostrar cursos e suas disciplinas
SELECT 
    C.Nome_Curso,
    Di.Nome_Disciplina
FROM Curso C
JOIN Curso_Disciplina CD ON C.Cod_Curso = CD.Cod_Curso
JOIN Disciplina Di ON CD.Cod_Disciplina = Di.Cod_Disciplina;

-- Mostrar alunos com seus endereços completos
SELECT 
    A.Nome_Aluno,
    TL.Tipo_Logradouro,
    E.Nome_Rua,
    ...
    E.CEP
FROM Aluno A
JOIN Endereco_Aluno E ON A.RA = E.RA
JOIN Tipo_Logradouro TL ON E.Cod_Tipo_Logradouro = TL.Cod_Tipo_Logradouro;

-- Mostrar histórico dos alunos
SELECT 
    A.Nome_Aluno,
    H.Data_Inicio,
    H.Data_Final
...
-- Contar quantos alunos existem por curso
SELECT 
    C.Nome_Curso,
